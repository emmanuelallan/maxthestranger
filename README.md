...
- 🌱 I’m currently a mentor at `microverse` with a love for `JavaScript`, `React`, `Ruby/Ruby on Rails` & `Node Js`. I also produce [`music`](https://music.maxthestranger.com/) and create content in my spare time. Open to new opportunities.
